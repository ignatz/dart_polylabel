...
List<List<PointDouble>> toPolygon(List original) {
  return original
      .map((polygon) => (polygon as List)
          .map((p) =>
              PointDouble((p.first as num).toDouble(), (p.last as num).toDouble()))
          .toList())
      .toList();
}

List<List<PointDouble>> loadData(String fixtureFile) {
  ...
  group('polylabel', () {
    ...
    test('finds pole of inaccessibility for water1 and precision 1', () {
      ...
      for (int i = 0; i < N; ++i) {
        ...
        expect(p.point, PointDouble(3865.85009765625, 2124.87841796875));
    ...
    test('finds pole of inaccessibility for water1 and precision 50', () {
      ...
      expect(p.point, PointDouble(3854.296875, 2123.828125));
    ...
    test(
      ...
      () {
        ...
        expect(p.point, PointDouble(3263.5, 3263.5));
    ...
    test('works on degenerate polygons', () {
      ...
      expect(p1.point, PointDouble(0, 0));
      ...
      expect(p2.point, PointDouble(0, 0));
